        ...
        <div class="modal-dialog" role="document">
          ...
          background-image:url('images/m.jpg');">
                                ...
                                <div class="card border-0" style="background-color:transparent">
                                    <div class="card-body">
                                        <div class="text-center text-white">
                                            ...
                                            <p class="card-text text-warning"><i class="fa fa-quote-left"></i>&nbsp;{{ $musicView_description }}&nbsp;<i class="fa fa-quote-right"></i></p>
                                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-dark text-white" data-dismiss="modal" wire:click="closeView()">Close</button>
                </div>
            </div>
        </div>
    </div>
